...
import { User, Mail, Phone, Camera, Loader2, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-display font-bold text-coffee-950 dark:text-cream-50">Profile Settings</h1>
        <p className="text-coffee-500 dark:text-coffee-400 text-sm">Manage your personal information and contact details.</p>
      </div>
      ...
      >
        ...
        <div className="p-8 border-b border-coffee-100 dark:border-gold-500/10 bg-gradient-to-r from-coffee-50/50 via-transparent to-transparent dark:from-coffee-950/20 dark:to-transparent flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="text-center sm:text-left space-y-2">
            <h3 className="text-xl font-display font-bold text-coffee-950 dark:text-cream-50">Profile Photo</h3>
                ...
                <div className="flex items-center p-4 bg-coffee-50/30 dark:bg-coffee-950/20 border border-coffee-100 dark:border-gold-500/5 rounded-2xl">
                  <div className="text-xs text-coffee-500 dark:text-coffee-400 leading-relaxed">
                    <p className="font-semibold text-coffee-950 dark:text-cream-100 flex items-center gap-1 mb-0.5">
                      <ShieldCheck className="w-4 h-4 text-forest-500" /> Secure Account
                    </p>
                    Email changes require contacting customer support to ensure security.
                  </div>
                </div>
              </div>
            </div>
